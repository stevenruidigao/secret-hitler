...
import { checkBadgesGamesPlayed } from '../../routes/socket/badges.mjs';
import { profiles } from '../../routes/socket/models.mjs';
import { flattenListOpts } from '../../utils/index.js';
...
export function profileDelta(username, game) {
...
export function updateProfiles(game, gameSummary, options = {}) {
