import { obfIP as ipv4 } from './ip-obfuscator-v4.mjs';
import { obfIP as ipv6 } from './ip-obfuscator-v6.mjs';
...
export const expandAndSimplify = ip => {
	if (ip && ip.includes(':')) {
...
export const doesIPMatchCIDR = (cidr, ip) => {
