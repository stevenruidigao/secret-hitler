 ...
 */
export const sendUserList = socket => {
...
export const getModInfo = (games, users, socket, queryObj, count = 1, isTrial, isAEM) => {
...
export const sendSignups = socket => {
...
export const sendAllSignups = socket => {
...
export const sendPrivateSignups = socket => {
 ...
 */
export const sendModInfo = (games, socket, count, isTrial, isAEM) => {
 ...
 * @param {object} socket - user socket reference.
 */
export const sendUserGameSettings = socket => {
 ...
 */
export const sendPlayerNotes = (socket, data) => {
 ...
 */
export const sendReplayGameData = (socket, uid) => {
	Game.findOne({ uid })
		.select({ _id: 0, _v: 0 })
		.then((game, err) => {
			if (err) {
 ...
 */
export const sendGameList = (socket, isAEM) => {
	// eslint-disable-line one-var
	if (socket) {
 ...
 * @param {object} socket - user socket reference.
 */
export const sendUserReports = socket => {
	PlayerReport.find()
		.sort({ $natural: -1 })
		.limit(500)
		.then(reports => {
 ...
 * @param {object} socket - user socket reference.
 */
export const sendGeneralChats = socket => {
 ...
 */
export const updateUserStatus = (passport, game, override) => {
 ...
 * @param {string} uid - uid of game.
 */
export const sendGameInfo = (socket, uid) => {
