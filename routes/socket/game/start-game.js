...
const beginGame = game => {
  ...
  const roles =
      [ {cardName : 'hitler', icon : 5, team : 'fascist'} ]
          .concat(_.shuffle(
              ...
              if (!game.general.disableGamechat) {
                player.gameChats.push({
                  ...
                  chat : [
                    ...
                    {
                      text : customGameSettings.fascistCount == 1
                                 ? '1 fascist'
                                 : customGameSettings.fascistCount == 2
                                       ? '2 fascists'
                                       : '3 fascists',
...
module.exports = game => {
  ...
  game.general.type =
      game.general.playerCount < 7
          ? 0
          : game.general.playerCount < 9 ? 1 : 2; // different fascist tracks
