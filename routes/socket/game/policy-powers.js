        ...
        () => {
          president.cardFlingerState[0].cardStatus.isFlipped =
              president.cardFlingerState[1].cardStatus.isFlipped =
                  president.cardFlingerState[2].cardStatus.isFlipped = true;
          sendInProgressGameUpdate(game, true);
        },
          ...
          if (!game.general.disableGamechat) {
            president.gameChats.push({
              ...
              chat : [
                {
                  text :
                      'You peek at the top 3 policies and see that they are a '
                },
                {
...
module.exports.selectOnePolicy = (passport, game) => {
  ...
  if (!game.private.lock.selectOnePolicy &&
    ...
    president.cardFlingerState = [ {
      ...
      action : 'active',
      cardStatus :
          {isFlipped : false, cardFront : 'policy', cardBack : `${policy}p`}
    } ];
          ...
          if (!game.general.disableGamechat) {
            president.gameChats.push({
              ...
              chat : [
                ...
                {text : policy, type : policy}, {text : ' policy.'}
              ]
            });
          }
                              ...
                              if (game.gameState.timedModeEnabled) {
                                ...
                                game.private.replayGameChats.push({
                                  ...
                                  chat : [
                                    ...
                                    {
                                      text :
                                          ' was forced by the timer to randomly select whether to discard the top policy.'
                                    }
                                  ]
                                });
                              }
        ...
        () => {
          const chat = {
            ...
            chat : [
              ...
              {
                text : data.vote ? ' has chosen to discard the top card.'
                                 : ' has chosen to keep the top card.'
              }
            ]
          };
...
const selectBurnCard =
    module.exports.selectBurnCard; // site crashes without this line xd
...
module.exports.investigateLoyalty = game => {
  ...
  const hasTarget =
      president.playersState
          .filter((player, i) => i !== presidentIndex &&
  ...
  if (!hasTarget) {
    ...
    seatedPlayers.forEach((player, i) => { player.gameChats.push(chat); });
  ...
  if (!game.private.lock.investigateLoyalty &&
    ...
    president.playersState
        .filter((player, i) => i !== presidentIndex &&
                               !seatedPlayers[i].isDead &&
                               !seatedPlayers[i].wasInvestigated)
        .forEach(player => { player.notificationStatus = 'notification'; });
    game.publicPlayersState[presidentIndex].isLoader = true;
...
module.exports.selectPartyMembershipInvestigate = (passport, game, data,
  ...
  if (!game.private.lock.selectPartyMembershipInvestigate &&
    ...
    if (!seatedPlayers[playerIndex].isDead &&
        !seatedPlayers[playerIndex].wasInvestigated) {
      game.gameState.audioCue = 'selectedInvestigate';
      seatedPlayers[playerIndex].wasInvestigated = true;

      president.playersState.forEach(
          player => { player.notificationStatus = ''; });

      game.private.summary = game.private.summary.updateLog(
          {investigationId : playerIndex, investigatorId : presidentIndex});
      ...
      setTimeout(
          () => {
            ...
            president.playersState[playerIndex].cardStatus = {
              isFlipped : true,
              cardBack : {cardName : `membership-${playersTeam}`}
            };
            ...
            if (!game.general.disableGamechat) {
                  ...
                  .forEach(player => {
                    chat.chat = [
                      ...
                      {text : ' investigates the party membership of '}, {
                        text : game.general.blindMode
                                   ? `{${playerIndex + 1}}`
                                   : `${seatedPlayers[playerIndex].userName} {${
                                         playerIndex + 1}}`,
                        type : 'player'
                      },
                      {text : '.'}
              ...
              president.gameChats.push({
                ...
                chat : [
                  ...
                  {text : playersTeam, type : playersTeam}, {text : ' team.'}
                ]
              });
            }
            ...
            const modOnlyChat = {
              ...
              chat : [
                ...
                {text : ' sees a '}, {text : playersTeam, type : playersTeam},
                {text : ' loyalty card.'}
              ]
            };
            game.private.hiddenInfoChat.push(modOnlyChat);
      ...
      setTimeout(
          ...
          process.env.NODE_ENV === 'development' ? 100
          : experiencedMode                      ? 4000
                                                 : 6000);

      setTimeout(
          () => {
            game.publicPlayersState[playerIndex].cardStatus.cardDisplayed =
                false;
            president.playersState[playerIndex].cardStatus.cardBack = {};
            president.playersState[presidentIndex].claim =
                'didInvestigateLoyalty';
            sendInProgressGameUpdate(game, true);
            startElection(game);
          },
          process.env.NODE_ENV === 'development' ? 100
          : experiencedMode                      ? 4200
                                                 : 8000);
    }
  }
};
...
module.exports.showPlayerLoyalty = game => {
  ...
  if (!game.private.lock.showPlayerLoyalty &&
    ...
    game.publicPlayersState[presidentIndex].isLoader = true;
    game.gameState.clickActionInfo = [
      president.userName, seatedPlayers
                              .filter((player, i) => i !== presidentIndex &&
                                                     !seatedPlayers[i].isDead)
                              .map(player => seatedPlayers.indexOf(player))
    ];
...
module.exports.selectPartyMembershipInvestigateReverse = (passport, game, data,
  ...
  if (!game.private.lock.selectPartyMembershipInvestigateReverse &&
    ...
    if (!targetPlayer.isDead) {
      ...
      game.private.summary = game.private.summary.updateLog(
          {investigationId : presidentIndex, investigatorId : playerIndex});
          ...
          () => {
            ...
            if (!game.general.disableGamechat) {
                  ...
                  {text : 'You have shown your party membership card to '}, {
                    text :
                        game.general.blindMode
                            ? `{${playerIndex + 1}}`
                            : `${targetPlayer.userName} {${playerIndex + 1}}`,
                    type : 'player'
                  },
                  {text : '.'}
                ]
              ...
              targetPlayer.gameChats.push({
                ...
                chat : [
                  {
                    text : game.general.blindMode ? `{${presidentIndex + 1}}`
                                                  : `${president.userName} {${
                                                        presidentIndex + 1}}`,
                    type : 'player'
                  },
                  {
                    text :
                        ' has shown you their party membership, and you determine that they are on the '
                  },
                  {text : playersTeam, type : playersTeam}, {text : ' team.'}
                ]
              });
            ...
            const modOnlyChat = {
              ...
              chat : [
                ...
                {text : ' shows their '},
                {text : playersTeam, type : playersTeam},
                {text : ' loyalty card.'}
              ]
            };
            game.private.hiddenInfoChat.push(modOnlyChat);
            ...
            if (!game.general.disableGamechat &&
                !(game.private.seatedPlayers[presidentIndex].role.cardName ===
                      'hitler' &&
                  targetPlayer.role.team === 'fascist')) {
              targetPlayer.playersState[presidentIndex].nameStatus =
                  playersTeam;
            }
      ...
      setTimeout(
          () => {
            game.gameState.audioCue = '';
            targetPlayer.playersState[presidentIndex].cardStatus.isFlipped =
                false;
            sendInProgressGameUpdate(game, true);
          },
          process.env.NODE_ENV === 'development' ? 100
      ...
      setTimeout(
          () => {
            game.publicPlayersState[presidentIndex].cardStatus.cardDisplayed =
                false;
            targetPlayer.playersState[presidentIndex].cardStatus.cardBack = {};
            targetPlayer.playersState[playerIndex].claim =
                'didInvestigateLoyalty';
            sendInProgressGameUpdate(game, true);
            startElection(game);
          },
...
module.exports.selectSpecialElection = (passport, game, data, socket) => {
  const {playerIndex} = data;
  const {presidentIndex} = game.gameState;
  const gameChat = {timestamp : new Date(), gameChat : true, chat : []};
  ...
  if (!game.private.lock.selectSpecialElection &&
    ...
    game.private.summary =
        game.private.summary.updateLog({specialElection : data.playerIndex});

    game.publicPlayersState[game.gameState.presidentIndex].isLoader = false;

    game.private.seatedPlayers[game.gameState.presidentIndex]
        .playersState.forEach(player => { player.notificationStatus = ''; });

    if (!game.general.disableGamechat) {
      seatedPlayers.filter(player => player.userName !== president.userName)
          .forEach(player => {
            gameChat.chat = [
              {text : 'President '}, {
                text : game.general.blindMode
        ...
        .filter((player, index) =>
                    ...
                    ((!game.customGameSettings.fasCanShootHit &&
                      !(president.role.cardName === 'fascist' &&
                        seatedPlayers[index].role.cardName === 'hitler')) ||
                     (game.customGameSettings.fasCanShootHit &&
                      !(president.role.cardName === 'fascist' &&
                        seatedPlayers[index].role.cardName === 'hitler')) ||
                     (game.customGameSettings.fasCanShootHit &&
    ...
    game.gameState.clickActionInfo = [
      ...
      seatedPlayers
          .filter((player, i) =>
                      ...
                      ((!game.customGameSettings.fasCanShootHit &&
                        !(president.role.cardName === 'fascist' &&
                          seatedPlayers[i].role.cardName === 'hitler')) ||
                       (game.customGameSettings.fasCanShootHit &&
                        !(president.role.cardName === 'fascist' &&
                          seatedPlayers[i].role.cardName === 'hitler')) ||
                       (game.customGameSettings.fasCanShootHit &&
...
module.exports.selectPlayerToExecute = (passport, game, data, socket) => {
  ...
  if (playerIndex === presidentIndex || !selectedPlayer ||
  ...
  const nonPresidentChat = {
    ...
    chat : [
      ...
      {text : ' selects to execute '}, {
        text : game.general.blindMode
                   ? `{${playerIndex + 1}}`
                   : `${selectedPlayer.userName} {${playerIndex + 1}}`,
        type : 'player'
      },
      {text : '.'}
    ]
  ...
  if (!game.private.lock.selectPlayerToExecute &&
    ...
    if (!game.general.disableGamechat) {
      ...
      seatedPlayers.filter(player => player.userName !== president.userName)
          .forEach(player => { player.gameChats.push(nonPresidentChat); });
    ...
    setTimeout(() => {
      ...
      if (selectedPlayer.role.cardName === 'hitler') {
        const chat = {
          ...
          gameChat : true,
          chat : [
            {text : 'Hitler', type : 'hitler'}, {text : '  has been executed.'}
          ]
        };
        ...
        seatedPlayers.forEach(p => {
          if (p.role.cardName == 'liberal' && !p.isDead)
            libAlive = true;
        });
        if (!libAlive) {
          const chat = {
            ...
            gameChat : true,
            chat : [
              {text : 'All '}, {text : 'liberals', type : 'liberal'},
          ...
          seatedPlayers.forEach(
              (player, i) => { player.gameChats.push(chat); });
          ...
          if (playersAlive <= 2) {
            const chat = {
              ...
              gameChat : true,
              chat : [
                {text : 'Hitler', type : 'hitler'}, {text : ' and one '},
                {text : 'liberal', type : 'liberal'},
            ...
            const playCard = () => {
              ...
              game.trackState.enactedPolicies.push(
                  {position : 'middle', cardBack : policy, isFlipped : false});
              ...
              game.trackState.enactedPolicies[index].position =
                  policy === 'liberal'
                      ? `liberal${game.trackState.liberalPolicyCount}`
              ...
              if (game.trackState.liberalPolicyCount === 5 ||
                ...
                game.gameState.audioCue =
                    game.trackState.liberalPolicyCount === 5 ? 'liberalsWin'
                                                             : 'fascistsWin';
                setTimeout(() => {
                  game.publicPlayersState.forEach(
                  ...
                  if (process.env.NODE_ENV === 'development') {
                    completeGame(game, game.trackState.liberalPolicyCount === 1
                                           ? 'liberal'
                                           : 'fascist');
                  } else {
