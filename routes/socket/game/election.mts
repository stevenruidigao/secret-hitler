...
export const selectChancellorVoteOnVeto = (passport: any, game: any, data: any, socket: any) => {
	...
	const president = game.private.seatedPlayers[game.gameState.presidentIndex];
	const chancellorIndex = game.publicPlayersState.findIndex((player: any) => player.governmentStatus === 'isChancellor');
	const chancellor = game.private.seatedPlayers.find((player: any) => player.userName === game.private._chancellorPlayerName);
	const publicChancellor = game.publicPlayersState[chancellorIndex];
...
export const selectVoting = (passport: any, game: any, data: any, socket: any, force = false) => {
	...
	const passedElection = (socket: any) => {
		...
		const verifyCorrect = (policy: any) => {
	...
	const flipBallotCards = (socket: any) => {
		...
		setTimeout(
			() => {
				...
				game.publicPlayersState.forEach((play: any, i: number) => {
