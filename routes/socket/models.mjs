...
export const setLastGenchatModPingAsync = async date => {
...
export const getPowerFromRole = role => {
...
export const getPowerFromName = name => {
...
export const getPowerFromUser = user => {
...
export const formattedUserList = isAEM => {
	const prune = value => {
...
export const verifyBypass = key => {
	return bypassKeys.indexOf(key) >= 0;
};

export const consumeBypass = (key, user, ip) => {
...
export const testIP = (IP, callback) => {
